...
Param (
[switch]$SkipAzureModuleInstall
)

if (-not $SkipAzureModuleInstall)
...
$PublicAddress = (Get-AzureRmPublicIpAddress -ResourceGroupName $rgname) | Where-Object -Property Name -EQ "W8publicIP"
